                           ...
                           <div class="offcanvas-body">
                               <ul class="navbar-nav nav-pills flex-column justify-content-end flex-grow-1">
                                <?php if ($hasil['level'] == 1 || $hasil['level'] == 2) { ?>
                                   ...
                                   <?php if ($hasil['level'] == 1 || $hasil['level'] == 2) { ?>
                                       <li class="nav-item">
                                           <a class="nav-link ps-2 <?php echo ((isset($_GET['x']) && $_GET['x'] == 'katmenu') ||  !isset($_GET['x'])) ?
                                                                        'active link-light' : 'link-dark'; ?>" aria-current="page" href="katmenu"><i class="bi bi-tags"></i> Kategori Menu</a>
                                       </li>
                                   <?php } ?>
                                   ...
                                   <?php if ($hasil['level'] == 1) { ?>
                                       ...
                                       <?php if ($hasil['level'] == 1 || $hasil['level'] == 2) { ?>
                                        ...
                                        <?php if ($hasil['level'] == 1) { ?>
                                           <li class="nav-item">
                                               <a class="nav-link ps-2 <?php echo (isset($_GET['x']) && $_GET['x'] == 'laporan') ?
                                                                            'active link-light' : 'link-dark'; ?>" href="laporan"><i class="bi bi-graph-up-arrow"></i> Laporan Penjualan</a>
                                           </li>
                                       <?php } ?>                          
                               </ul>
                           </div>
