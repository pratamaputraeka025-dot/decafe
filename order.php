        ...
        <div class="card-body">
            <div class="row">
                <div class="col d-flex justify-content-end">
                    <div class="col d-flex justify-content-end">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalTambahMenu"> Tambah Order</button>
                    </div>
                </div>
            ...
            ?>
                    ...
                    <!-- akhir Modal Delete LAMA -->

                    <!-- Modal Delete ALL -->
                    <div class="modal fade" id="ModalDeleteComplete<?php echo $row['id_order'] ?>" tabindex="-1"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-md modal-fullscren-md-down">
                            <div class="modal-content">
                                <div class="modal-header bg-danger text-white">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">
                                        <i class="bi bi-trash-fill"></i> Hapus Order & Semua History
                                    </h1>
                                ...
                                <div class="modal-body">
                                    <form class="needs-validation" novalidate action="proses/proses_delete_order.php" method="POST">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <p>Apakah anda yakin ingin menghapus order atas nama <b><?php echo $row['pelanggan'] ?></b>?</p>
                                            <p><strong>Kode Order:</strong> <?php echo $row['id_order'] ?></p>

                                            <div class="alert alert-info" role="alert">
                                                <small><i class="bi bi-info-circle"></i> <strong>Yang akan dihapus:</strong></small>
                                                <ul class="mb-0 mt-2 small">
                                                    <li>Data order utama</li>
                                                    <li>Semua item order</li>
                                                    <li>Data pembayaran (jika ada)</li>
                                                    <li>Stok menu akan dikembalikan</li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                            <button type="submit" class="btn btn-danger" name="delete_order_validate" value="1234">
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary btn-sm me-1 disabled" : "btn btn-warning btn-sm me-1"; ?>" data-bs-toggle="modal"
                                            data-bs-target="#ModalEdit<?php echo $row['id_order'] ?>"><i class="bi bi-pencil-square"></i></i></button>
                                        <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary btn-sm me-1 disabled" : "btn btn-danger btn-sm me-1"; ?>" data-bs-toggle="modal"
                                            data-bs-target="#ModalDelete<?php echo $row['id_order'] ?>"><i class="bi bi-trash"></i></i></button>
                                        <td>
                                        <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#ModalDeleteComplete<?php echo $row['id_order'] ?>" title="Hapus Order & Semua History">
