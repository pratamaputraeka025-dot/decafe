    ...
    <div class="card">
        ...
        <div class="card-body">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_user.php" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control" id="floatingPassword" placeholder="Password" name="password" required minlength="6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control" id="floatingRePassword" placeholder="Re-Password" name="repassword" required minlength="6">
                                            <label for="floatingRePassword">Ulangi Password</label>
                                            <div class="invalid-feedback">
                                                Ulangi Password.
                                            </div>
                                        </div>
            ...
            ?>
                ...
                <?php
                // Tambahkan di bagian foreach modal user, setelah Modal Reset Password
                foreach ($result as $row) {
                ?>

                    <!-- Modal Edit Password User -->
                    <div class="modal fade" id="ModalEditPassword<?php echo $row['id'] ?>" tabindex="-1"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-md modal-fullscren-md-down">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Password User</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form class="needs-validation" novalidate action="proses/proses_edit_password_user.php" method="POST">
                                        <input type="hidden" value="<?php echo $row['id'] ?>" name="id">
                                        <div class="col-lg-12">
                                            <div class="alert alert-info">
                                                <strong>User:</strong> <?php echo $row['nama'] ?> (<?php echo $row['username'] ?>)
                                            </div>

                                            <div class="form-floating mb-3">
                                                <input type="password" class="form-control" id="floatingNewPassword"
                                                    placeholder="Password Baru" name="password_baru" required minlength="6">
                                                <label for="floatingNewPassword">Password Baru</label>
                                                <div class="invalid-feedback">
                                                    Masukan Password Baru (minimal 6 karakter).
                                                </div>
                                            </div>

                                            <div class="form-floating mb-3">
                                                <input type="password" class="form-control" id="floatingReNewPassword"
                                                    placeholder="Ulangi Password Baru" name="repassword_baru" required minlength="6">
                                            ...
                                            <div class="alert alert-warning">
                                                <small><i class="bi bi-exclamation-triangle"></i> Password akan diubah untuk user ini.</small>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <button type="submit" class="btn btn-primary" name="edit_password_user_validate" value="1234">Update Password</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <!-- akhir Modal Edit Password User -->
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <button class="btn btn-info btn-sm me-1" data-bs-toggle="modal"
                                            data-bs-target="#ModalView<?php echo $row['id'] ?>" title="Lihat Detail">
                                            <i class="bi bi-eye"></i>
                                        </button>
                                        <button class="btn btn-warning btn-sm me-1" data-bs-toggle="modal"
                                            data-bs-target="#ModalEdit<?php echo $row['id'] ?>" title="Edit User">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>
                                        <button class="btn btn-danger btn-sm me-1" data-bs-toggle="modal"
                                            data-bs-target="#ModalDelete<?php echo $row['id'] ?>" title="Hapus User">
                                            <i class="bi bi-trash"></i>
                                        </button>
                                        <button class="btn btn-primary btn-sm me-1" data-bs-toggle="modal"
                                            data-bs-target="#ModalEditPassword<?php echo $row['id'] ?>" title="Edit Password">
                                            <i class="bi bi-key-fill"></i>
                                        </button>
                                        <button class="btn btn-secondary btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#ModalResetPassword<?php echo $row['id'] ?>" title="Reset Password ke Default">
